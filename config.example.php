<?php
/**
 * فایل تنظیمات سیستم (نمونه)
 * 
 * این فایل را به config.php تغییر نام دهید و اطلاعات مورد نیاز را تنظیم کنید
 * 
...
$db_config = [
    'host'     => 'localhost',
    'username' => 'username',  // نام کاربری دیتابیس را تغییر دهید
    'password' => 'password',  // رمز عبور دیتابیس را تغییر دهید
    'database' => 'database_name', // نام دیتابیس را تغییر دهید
    'charset'  => 'utf8mb4',
