    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">ویرایش کاربر</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="index.php?controller=user&action=edit_user">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="role" name="role" required>
                                    ...
                                    <option value="admin" <?php echo $user['role'] === 'admin' ? 'selected' : ''; ?>>مدیر سیستم</option>
                                    <option value="manager" <?php echo $user['role'] === 'manager' ? 'selected' : ''; ?>>مدیر</option>
                                    <option value="inventory" <?php echo $user['role'] === 'inventory' ? 'selected' : ''; ?>>کارشناس انبار</option>
                                    <option value="production" <?php echo $user['role'] === 'production' ? 'selected' : ''; ?>>کارشناس تولید</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-text">در صورت تمایل به تغییر رمز عبور، فیلد را پر کنید.</div>
                            </div>
                            <div class="col-md-6">
