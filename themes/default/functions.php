...
function theme_enqueue_styles() {
    ...
    echo '<link href="/mini/Inventory_Listing-WEB/assets/css/style.css?v=' . THEME_VERSION . '" rel="stylesheet">' . PHP_EOL;
...
function theme_enqueue_scripts() {
    ...
    // Main application JS
    echo '<script src="/mini/Inventory_Listing-WEB/assets/js/app.js?v=' . THEME_VERSION . '"></script>' . PHP_EOL;
...
function the_dashboard_card($args) {
    ...
    if ($card['link']) {
        echo '<a href="' . BASE_PATH . $card['link'] . '" class="btn ' . $card['button_class'] . ' w-100">';
