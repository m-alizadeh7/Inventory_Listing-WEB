        ...
        <div class="d-none d-lg-flex align-items-center desktop-actions">
            ...
            <div class="dropdown me-2">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="inventory_records.php"><i class="fas fa-list me-2"></i>موجودی انبار</a></li>
                    <?php if ($security->hasPermission('inventory.categories')): ?>
                    <li><a class="dropdown-item" href="inventory_categories.php"><i class="fas fa-tags me-2"></i>گروه‌های کالا</a></li>
                    <?php endif; ?>
                    <?php if ($security->hasPermission('inventory.count')): ?>
                    <li><a class="dropdown-item" href="physical_count.php"><i class="fas fa-clipboard-list me-2"></i>شمارش فیزیکی</a></li>
                    <?php endif; ?>
                    <?php if ($security->hasPermission('inventory.withdraw')): ?>
                    <li><a class="dropdown-item" href="manual_withdrawals.php"><i class="fas fa-minus-circle me-2"></i>خروج موردی</a></li>
                    <?php endif; ?>
                    <?php if ($security->hasPermission('inventory.manage')): ?>
                    <li><a class="dropdown-item" href="emergency_notes.php"><i class="fas fa-exclamation-triangle me-2"></i>یادداشت‌های اضطراری</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="new_inventory.php"><i class="fas fa-plus me-2"></i>انبارگردانی جدید</a></li>
                    <?php endif; ?>
                    <li><a class="dropdown-item" href="view_inventories.php"><i class="fas fa-chart-line me-2"></i>گزارش‌ها</a></li>
                </ul>
            </div>
            <?php endif; ?>
            ...
            <div class="dropdown me-2">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="production_orders.php"><i class="fas fa-list-alt me-2"></i>سفارشات تولید</a></li>
                    <?php if ($security->hasPermission('production.manage')): ?>
                    <li><a class="dropdown-item" href="new_production_order.php"><i class="fas fa-plus me-2"></i>سفارش جدید</a></li>
                    <?php endif; ?>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="devices.php"><i class="fas fa-cog me-2"></i>دستگاه‌ها</a></li>
                    <li><a class="dropdown-item" href="device_bom.php"><i class="fas fa-list me-2"></i>BOM دستگاه‌ها</a></li>
                </ul>
            </div>
            <?php endif; ?>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="users.php"><i class="fas fa-users me-2"></i>مدیریت کاربران</a></li>
                    <?php endif; ?>
                    <?php if ($security->hasPermission('system.admin')): ?>
                    <li><a class="dropdown-item" href="settings.php"><i class="fas fa-cog me-2"></i>تنظیمات سیستم</a></li>
                    <?php endif; ?>
                    <li><hr class="dropdown-divider"></li>
