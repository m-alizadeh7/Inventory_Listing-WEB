            ...
            <div class="col-md-4">
                <div class="card hover-lift">
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo BASE_PATH; ?>settings.php" class="btn btn-info">
            ...
            <div class="col-md-4">
                <div class="card hover-lift">
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo BASE_PATH; ?>suppliers.php" class="btn btn-primary">
            ...
            <div class="col-md-4">
                <div class="card hover-lift">
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo BASE_PATH; ?>backup.php" class="btn btn-success">
